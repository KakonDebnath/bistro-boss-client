                ...
                <div className="m-4 md:m-10 p-5 md:p-16 bg-white rounded-lg">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                <button className="transition-all duration-300 flex items-center gap-2 bg-gradient-to-r from-[#835D23] to-[#B58130] text-white py-3 px-5  hover:bg-gradient-to-r hover:from-[#B58130] hover:to-[#835D23]">Add Item <FaUtensils></FaUtensils></button>
                            </div>
                        </div>
                    </form>
                </div>
