...
const FeaturedMenu = () => {
    return (
        <section className="featured-item py-32 mt-20">
            ...
            <div className="flex items-center gap-10 text-white">
                ...
                <div>
                    ...
                    <button className="border-b-[3px] border-black rounded-b-lg mt-12 mb-20 uppercase px-5 py-4  transition-all duration-500 text-black hover:bg-black hover:text-white ">Read More</button>
                </div>
            </div>
        </section>
    );
